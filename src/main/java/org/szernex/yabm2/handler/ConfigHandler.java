...
public class ConfigHandler
{
	...
	public static void loadConfig()
	{
		...
		maxBackupCount = configuration.getInt("maxBackupCount", category, maxBackupCount, 0, Integer.MAX_VALUE, "The number of non-persistent backups to keep. If the total backup count exceeds this number the oldest backups will be deleted.\nA value of 0 disables backup consolidation.");
